...
#     return dados
def buscar():
    musicas = open("./buscar_musicas/musicas.txt",'r')
    linhas = musicas.readlines()
    historico = open("./buscar_musicas/historico.txt", 'a')
        ...
        for linha in linhas:
            ...
            if len(dados) == 4:
                ...
                if nome_musica == busque or nome_artista == busque:
                    ...
                    print('-'*10) 
                    historico.write(f'{nome_musica},{nome_artista},{ano_musica},{estilo_musical}\n')
                    input('Precione ENTER para voltar ao menu de tarefas')
                    
                    
                    return (f'{nome_musica},{nome_artista},{ano_musica},{estilo_musical}\n')  # ✅ retorna imediatamente os dados corretos
